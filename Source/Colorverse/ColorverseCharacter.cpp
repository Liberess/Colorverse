...
{
	// If Colorverse is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Colorverse.Build.cs is not automatically propagated
